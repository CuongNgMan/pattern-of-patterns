...
var _currencyConverter = require("./controller/currency-converter");
const root = document.querySelector('#root');
new _currencyConverter.CurrencyConverter(root);

},{"./controller/currency-converter":"55LA8"}],"55LA8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CurrencyConverter", ()=>CurrencyConverter
);
var _eventing = require("../common/eventing");
var _currencyListMulti = require("../model/currency-list-multi");
var _currencyListSingle = require("../model/currency-list-single");
var _currencyConverter = require("../view/currency-converter");
class CurrencyConverter {
    constructor(root){
        this._event = new _eventing.Eventing();
        this.onConverterModeChangeHandler = (data)=>{
            this.model = data === 'multi' ? new _currencyListMulti.CurrencyListMultiMode() : new _currencyListSingle.CurrencyListSingleMode();
            this.init(this.view.currentMode);
            this.registerEvents();
        };
        this.onConverterViewChangeHandler = (data)=>{
            this.renderBindingView(this.view.currentMode);
        };
        this.onConverterValueChangeHandler = async (value, className)=>{
        ...
        this.view = new _currencyConverter.CurrencyConverterView(root);
        this.model = new _currencyListSingle.CurrencyListSingleMode();
        this.init('input');
        this.registerEvents();
    }
    init(mode) {
    ...
    renderBindingView(mode1) {
        this.view.renderConverter(mode1);
    ...
    isConvertedToEuro(className) {
        return String.prototype.endsWith.apply(className, [
            '-EUR'
        ]);
    }
    isConvertedToCurrency(className1) {
        return String.prototype.startsWith.apply(className1, [
            'EUR-'
        ]);
    }
}

},{"../view/currency-converter":"lEIul","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","../common/eventing":"7VUaZ","../model/currency-list-multi":"bjpNE","../model/currency-list-single":"dy20g"}],"lEIul":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CurrencyConverterView", ()=>CurrencyConverterView
);
var _view = require("./view");
// import { CurrencyConverterItems, ViewMode, ConverterMode } from './currency-converter-items';
var _currencyConverterModeInput = require("./currency-converter-mode-input");
var _currencyConverterModeSlider = require("./currency-converter-mode-slider");
class CurrencyConverterView extends _view.View {
    constructor(root){
        super(root);
        this.modeToggleLabel = 'Mode toggler';
        this.viewToggleLabel = 'View toggler';
        this.currencyItemContainer = null;
    ...
    bindConverterMode(handler) {
        this.getElement('.converter-mode').addEventListener('change', (event)=>{
            const converterMode = event.target.checked ? 'multi' : 'single';
            handler(converterMode);
        });
    }
    bindConverterViewMode(handler1) {
        this.getElement('.converter-view').addEventListener('change', (event)=>{
            const viewMode = event.target.checked ? 'slider' : 'input';
            this.currentMode = viewMode;
            handler1(viewMode);
        });
    }
    bindCurrencyConverterHandler(handler2) {
        this.currencyConverter.bindEvents(handler2);
    }
    ...
    renderConverterByMode(mode1) {
        switch(mode1){
            case 'input':
                return new _currencyConverterModeInput.CurrencyConverterModeInput(this.currencyItemContainer, this.currencyData);
            case 'slider':
                return new _currencyConverterModeSlider.CurrencyConverterModeSlider(this.currencyItemContainer, this.currencyData);
            default:
                return new _currencyConverterModeInput.CurrencyConverterModeInput(this.currencyItemContainer, this.currencyData);
        }
    }
...
},{"./view":"9cGym","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","./currency-converter-mode-input":"1VF22","./currency-converter-mode-slider":"ebrgq"}],"9cGym":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class View {
    ...
    getAllElement(selector1) {
        return document.querySelectorAll(selector1);
    }
}
...
},{}],"1VF22":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CurrencyConverterModeInput", ()=>CurrencyConverterModeInput
);
var _view = require("./view");
class CurrencyConverterModeInput extends _view.View {
    constructor(root, data){
        super(root);
        this.elementEvents = new Set();
        this.render(data);
    }
    generateHTMLElement(data1) {
        const arrStr = data1.map((i)=>{
    ...
    render(data2) {
        this.root.innerHTML = this.generateHTMLElement(data2);
    }
}

},{"./view":"9cGym","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"ebrgq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CurrencyConverterModeSlider", ()=>CurrencyConverterModeSlider
);
var _view = require("./view");
class CurrencyConverterModeSlider extends _view.View {
    constructor(root, data){
        super(root);
        this.elementEvents = new Set();
        this.render(data);
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <input class='${i.currencyName}-EUR' type='range' min='1' max='${Math.floor(i.currencyRate * 1000)}' step='1' value='${i.convertedValue}'/>
                    </td>
                  </tr>
                </tbody>
              </table>
...
},{"./view":"9cGym","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"7VUaZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Eventing {
    constructor(){
        ...
        this.trigger = (event)=>{
            const handlers = this._events[event] || [];
            if (handlers.length) handlers.forEach((handler)=>handler()
            );
        };
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"bjpNE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CurrencyListMultiMode", ()=>CurrencyListMultiMode
);
...
class CurrencyListMultiMode {
    ...
    async fetch() {
        const response = await _axiosDefault.default.get(`${url}/rates`);
        const data = response.data;
        const result = [];
        for (let currency of data){
            const { id , currencyName , currencyRate , euroQuantity , convertedValue  } = currency;
            const c = new _currency.Currency(id, currencyName, currencyRate, euroQuantity);
    ...
    async save(id, data) {
        return await _axiosDefault.default.put(`${url}/rates/${id}`, data);
    }
    async setCurrencyValue(value, type, currencyName) {
    ...
    constructor(){
        this._events = new _eventing.Eventing();
        this.currencyList = [];
    }
}

},{"axios":"1IeuP","./currency":"7HeBj","../common/eventing":"7VUaZ","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"1IeuP":[function(require,module,exports) {
...
},{}],"7HeBj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Currency {
    ...
    currencyToEuro(value) {
        this.euroQuantity = value / this.currencyRate;
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"dy20g":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CurrencyListSingleMode", ()=>CurrencyListSingleMode
);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _currency = require("./currency");
...
},{"axios":"1IeuP","../common/eventing":"7VUaZ","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","./currency":"7HeBj"}]},["2HtCd","7PGg5"], "7PGg5", "parcelRequiree174")
